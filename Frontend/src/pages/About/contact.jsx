      ...
      >
        ...
        <p
          className="
            ...
            leading-none
            text-white
            text-[clamp(1.5rem,4vw,2.1875rem)]
          "
        >
        ...
        <p
          className="
            ...
            max-w-4xl
            break-words
            text-[clamp(0.8125rem,1.3vw,1rem)]
            font-normal
            leading-[1.6]
          ...
          "
        >
          Whether you're looking to automate a single workflow or build a
          custom ERP, our technical auditors are ready to find your efficiency
          gaps.
        </p>
