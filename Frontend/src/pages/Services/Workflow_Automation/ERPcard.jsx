    ...
    >
      ...
      >
        ...
        >
          <img
            src={supportCard}
            alt="Enterprise ERP & LMS Frameworks"
            className="
              absolute
              inset-0
              h-full
        ...
        >
          <div className="w-full min-w-0">
            ...
            <p
              ...
              "
            >
              Centralize your internal operations and training with custom
              platforms designed for your specific business rules.
            </p>
            ...
            >
              ...
              >
                ...
                <span className="font-semibold">ERP Development:</span>
              </li>
              ...
              >
                ...
                <span>
                  Full resource planning and inventory management systems.
                </span>
              </li>
              ...
              >
                ...
                <span>
                  Educational portals and employee training dashboards.
                </span>
              </li>
            </ul>
          </div>
          ...
          {/* ================= BUTTON ================= */}
          <div className="mt-auto pt-[clamp(1.5rem,3vw,2rem)]">
            <Link
              to="/contact"
              className="
                inline-flex
