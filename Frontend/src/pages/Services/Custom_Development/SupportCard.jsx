    ...
    >
      ...
      >
        ...
        >
          <img
            src={supportCard}
            alt="Core Standards & Legacy Support"
            className="
              absolute
              inset-0
              h-full
        ...
        >
          <div className="min-w-0 flex-1">
            ...
            <p
              ...
              "
            >
              We combine time-tested web standards with modern PHP practices to
              maintain and scale essential business websites.
            </p>
            ...
            >
              {/* PHP */}
              <Bullet>
                <span className="font-semibold">PHP / HTML5 / CSS3:</span>
              </Bullet>
              ...
              {/* Legacy Integration */}
              <Bullet>
                <span className="font-semibold">Legacy Integration:</span>
              </Bullet>
